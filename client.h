#ifndef P2P_WITH_EVENTING_P2PCLIENT_H
#define P2P_WITH_EVENTING_P2PCLIENT_H
...
public:
    ...
    static ClientConfig parseCommandLine(int argc, char *argv[]) {
        ...
        try {
            ...
            if (config.tcp_port == config.udp_port) {
                throw std::runtime_error("TCP and UDP ports must be different");
            }
...
#endif //P2P_WITH_EVENTING_P2PCLIENT_H